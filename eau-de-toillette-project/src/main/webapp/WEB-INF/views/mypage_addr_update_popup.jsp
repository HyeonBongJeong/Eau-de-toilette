...
<form id="mypage-popup-frm" action="mypageAddrUpdate.do?id=${id} " method="post">
...
$('#mypage-popup-frm').submit(function(event){ 
	...
	if(!pop_addr){
		...
		opener.document.location.href="mypageAddrUpdate.do?id=${id}&pop_addr="+pop_addr+"&pop_detail_addr="+pop_detail_addr+"&pop_name="+pop_name+"&pop_phone="+pop_phone+"&sd_id=${sd_id}"
		self.close();		
