...
<body>
    <div id="header">
        <div id="header-usermenu">
            <!-- <div id="header-usermenu-left">왼쪽엘리먼트</div>
            <div id="header-usermenu-right">오른쪽 엘리먼트</div> -->
            ...
            <a href="#" class="header-usermenu-title header-usermenu-title-1">로그인</a>
            <p class="header-usermenu-title header-usermenu-title-2">&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</p>
            <a href="#" class="header-usermenu-title header-usermenu-title-1" id="header-usermenu-register">회원가입</a>
        ...
        <div id="header-logo">
            <img id="logo" src="${pageContext.request.contextPath}/resources/images/index_logo.png" alt="마켓컬리 로고">
        </div>
    </div>
