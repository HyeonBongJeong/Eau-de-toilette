          ...
          <div id="mypage-side-section">
            ...
            <div class="mypage-personer-info">
                <div class = "mypage-personer-info-section">
                    <h2 class="order-manage-h2">이벤트 추가</h2>
					 
                    <br>
                    <hr style="background-color: black; height: 1px; margin-top: 30px;">
                    <div>
                    <form action="eventAdd.do" method="post" enctype="multipart/form-data">
                    <table id="order-manage-table">
                    	<tr>
                    		<td style="padding-bottom: 15px;">종료일</td>
                    		<td style="padding-bottom: 15px;"><input name="e-end" type="date"></td>
                    	</tr>
                    	<tr>
                    		<td style="padding-bottom: 15px;">제목</td>
                    		<td style="padding-bottom: 15px;"><input name="e-title" type="text" style="width: 93%; height: 30px; padding-left: 10px; border: 1px solid #ddd;"></td>
                    	</tr>
                    	<tr>
                    	...
                    	<tr>
	                    	<td colspan="2" style="text-align: right; padding-bottom: 20px;">
	                    	 <input type="submit" id="savebutton" value="저장하기" style="background-color: #5f0080; color: white; border: 1px solid #5f0080; width: 70px; height: 40px;">
	                   		 <input onclick="goback();" name="back-page" type="button" value="목록으로" style="background-color: #5f0080; color: white; border: 1px solid #5f0080; width: 70px; height: 40px;">
	                    	</td>
                    	</tr>
